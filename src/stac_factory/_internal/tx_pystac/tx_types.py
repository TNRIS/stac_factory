...
ContentInput = TypedDict(
    "ContentInput",
    {
        ...
        "txgio:categories": NotRequired[list[Category]],
        "keywords": NotRequired[list[str]],
        "extent": NotRequired[TypeExtent],
        "txgio:spatial_reference": NotRequired[list[str]],
        ...
        "txgio:s_three_bucket_key": NotRequired[str],
        "txgio:public": NotRequired[bool],
        "txgio:availability": NotRequired[bool],
        "txgio:last_modified": NotRequired[str],
        "txgio:last_edited_by": NotRequired[str],
        "txgio:template": NotRequired[str],
    },
)

# Default values
default_extent = TypeExtent(
    spatial={"bbox": []},
    temporal={"interval": [["1970-01-01T00:00:00Z", "1970-01-01T00:00:00Z"]]},
)
